...
<DIV class='title_line'><a href="../survey/list.do">${survey_title} </a>-설문항목 > 수정</DIV>
 ...
 <form name='frm' method='post' action='./update.do' class="form-horizontal">
    ...
    <div class="form-group col-md-1 float-left">
       <label class="control-label">순서</label>
         <input type='number' name='seqno' value='${surveyitemVO.seqno}' required="required" 
                   class="form-control">
    </div>  
    <div class="form-group col-md-7 float-left">
       <label class="control-label">설문 항목 이름</label>
         <input type='text' name='item_title' value='${surveyitemVO.item_title }' required="required" 
                  class="form-control">
    </div>
