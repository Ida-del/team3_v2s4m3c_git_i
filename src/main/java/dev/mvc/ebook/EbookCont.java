...
public class EbookCont {
  ...
  public ModelAndView create(@RequestParam(value = "cateno", defaultValue = "0") int cateno) {
    ModelAndView mav = new ModelAndView();
  ...
  public ModelAndView create(HttpServletRequest request, EbookVO ebookVO) {
    ModelAndView mav = new ModelAndView();
...
//  }
  ...
  public ModelAndView adm_list_thumb(@RequestParam(value = "cateno", defaultValue = "0") int cateno) {
  ...
  public ModelAndView adm_read(int eb_no) {
    ModelAndView mav = new ModelAndView();
  ...
  public ModelAndView update(HttpServletRequest request, EbookVO ebookVO) {
    ModelAndView mav = new ModelAndView();
  ...
  public ModelAndView delete(HttpServletRequest request, int eb_no) {
    ModelAndView mav = new ModelAndView();
  ...
  public String file_delete(HttpServletRequest request, int eb_no, int type) {
